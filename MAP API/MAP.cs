    ...
    public static class MAP
    {
        ...
        public static string CalculateDistance(string start, string goal)
        {
            ...
            //int divD;
                ...
                string url = string.Format("https://naveropenapi.apigw.ntruss.com/map-direction/v1/driving?start={0}&goal={1}&option=trafast&fueltype=gasoline&mileage=9.5", start, goal);
